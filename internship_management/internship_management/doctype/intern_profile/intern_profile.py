...
class InternProfile(Document):
	...
	if TYPE_CHECKING:
		...
		from internship_management.internship_management.doctype.assigned_assets.assigned_assets import AssignedAssets
		...
		assigned_assets: DF.Table[AssignedAssets]
		assigned_department: DF.Link | None
		career_objective: DF.Table[CareerObjective]
		county: DF.Literal["Baringo", "Bomet", "Bungoma", "Busia", "Elgeyo-Marakwet", "Embu", "Garissa", "Homa Bay", "Isiolo", "Kajiado", "Kakamega", "Kericho", "Kiambu", "Kilifi", "Kirinyaga", "Kisii", "Kisumu", "Kitui", "Kwale", "Laikipia", "Lamu", "Machakos", "Makueni", "Mandera", "Marsabit", "Meru", "Migori", "Mombasa", "Murang'a", "Nairobi", "Nakuru", "Nandi", "Narok", "Nyamira", "Nyandarua", "Nyeri", "Samburu", "Siaya", "Taita-Taveta", "Tana River", "Tharaka-Nithi", "Trans-Nzoia", "Turkana", "Uasin Gishu", "Vihiga", "Wajir", "West Pokot"]
		course: DF.Link
		...
		region: DF.Literal["Nairobi", "Central", "Coast", "Eastern", "Lower Eastern", "Mt. Kenya", "North Eastern", "Nyanza", "Rift Valley", "South Rift", "Western", "Upper Eastern"]
		...
		status: DF.Literal["Pending", "Assigned", "Active", "Completed", "Suspended", "Terminated"]
